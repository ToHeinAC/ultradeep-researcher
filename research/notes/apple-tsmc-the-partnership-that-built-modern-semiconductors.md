...
id: apple-tsmc-the-partnership-that-built-modern-semiconductors
tags:
- apple-earnings-durability-thesis-b8b3f1
- apple-silicon-margin
- tsmc-dependency
created: '2026-09-13T06:03:55.699795Z'
updated: '2026-09-15T19:32:22.091228Z'
...
fetched_at: '2026-09-13T06:03:55.678236Z'
...
deprecated: false
summary: 'SemiAnalysis (Dylan Patel et al., Jan 2026, paywalled preview) deep-dive
  on Apple-TSMC relationship, built on proprietary Foundry Industry Model and Apple
  Wafer Demand Model. Discloses specific (modeled, not company-disclosed) gross-margin
  figures: Mac GM expanded from ~28.5-29% to 39.5% after the Intel-to-Apple-Silicon
  transition (cited inconsistently within the same article as both 11pp and 10.5pp
  expansion); iPhone GM grew ~5pp (36.5% to 41.5%) from A4 to A18; combined annual
  chip savings exceed $7B (Intel $5B, Qualcomm $1.2B, Broadcom $700M, custom IP $500M+).
  States Apple''s C1/C2 in-house modem transition targets full Qualcomm elimination
  by 2027-2028, calling it a ''gross margin stacking opportunity.'' Documents deep
  TSMC dependency: Apple funded TSMC''s yield-learning curve since 20nm (2013), spend
  grew from $2B/yr (2014) to $24B/yr (2025), Apple share of TSMC revenue peaked at
  25% and settled to 20% in 2025; switching cost to Samsung/Intel estimated at $2-5B
  in redesign/requalification; Samsung 3nm yields (30-40%) still trail TSMC''s 80%+.
  Flags concentrating geopolitical risk: nearly all leading-edge Apple silicon manufactured
  at Fab 18, Tainan, ~100 miles from mainland China; TSMC Arizona <5% of leading-edge
  production, not material until 2028+. Also notes AI/HPC (Nvidia) is diluting Apple''s
  historical anchor-customer leverage at TSMC (Apple''s N2 share projected to drop
  to 48%, first time in a decade Apple is not dominant on a new node) — a competing
  narrative to the ''silicon = differentiation moat'' framing, since even Apple''s
  own silicon roadmap is contingent on a single foundry''s capacity allocation between
  Apple and AI/HPC customers. Also quotes Apple''s own SVP of Hardware Technologies
  Johny Srouji framing silicon as a product/experience decision, not a cost decision:
  ''It''s not about the chip. Apple is not a chip company.'''
utility_score: 16.0
---
...
[Already a paid subscriber? **Sign in**](https://substack.com/sign-in?redirect=%2Fp%2Fapple-tsmc-the-partnership-that-built&for_pub=semianalysis&change_user=false)
PreviousNext
© 2026 Dylan Patel[Privacy](https://substack.com/privacy)[Terms](https://substack.com/tos)[Collection notice](https://substack.com/ccpa#personal-data-collected)
